    ...
    public function FormData(Request $request)
    {
        try {
            ...
            $data = $request->validate([
                ...
                'address.vorname' => ['nullable', 'string'],
                'address.nachname' => ['nullable', 'string'],
                'address.strasse' => ['nullable', 'string'],
                'address.stadt' => ['nullable', 'string'],
                'address.plz' => ['nullable', 'string'],
                'address.land' => ['nullable', 'string'],
                'address.email' => ['nullable', 'email'],
                'address.telefon' => ['nullable', 'string'],
                ...
                'insuranceProvider' => ['required_if:insuranceType,gesetzlich', 'string', 'nullable'],
                'insuranceNumber' => ['required_if:insuranceType,gesetzlich', 'string', 'nullable'],
        ...
        $orderData = [
            ...
            'requestBedPads' => $data['requestBedPads'] ?? false,
            'isSameAsContact' => $data['isSameAsContact'] ?? false,
